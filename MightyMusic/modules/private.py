        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "📍 Instagram", url=f"https://www.instagram.com/ebnu_am/"),
                    InlineKeyboardButton(
    ...
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '📮 Channel', url=f"https://t.me/{SUPPORT_CHANNEL}"),
             InlineKeyboardButton(text = '📍 Instagram', url=f"https://t.me/{SUPPORT_GROUP}")],
...
async def ghelp(_, message: Message):
    await message.reply_text(
        f"""**📝 Hallo!!Saya adalah bot canggih yang dibuat untuk memutar musik di obrolan suara Grup & Saluran Telegram.**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
